...
class simple_html_dom
{
        ...
        protected function read_tag()
    {
        ...
        $this->char = (++$this->pos < $this->size) ? $this->doc[$this->pos] : null; 
                if ($this->char === '/') {
            $this->char = (++$this->pos < $this->size) ? $this->doc[$this->pos] : null;                                     $this->skip($this->token_blank);
            ...
            if ($parent_lower !== $tag_lower) {
                if (isset($this->optional_closing_tags[$parent_lower]) && isset($this->block_tags[$tag_lower])) {
                    ...
                    if (strtolower($this->parent->tag) !== $tag_lower) {
                        $this->parent = $org_parent;                         $this->parent->_[HDOM_INFO_END] = $this->cursor;
                        return $this->as_text_node($tag);
                    }
            ...
            $this->char = (++$this->pos < $this->size) ? $this->doc[$this->pos] : null;             return true;
        }
        ...
        $node->tag_start = $begin_tag_pos;
            ...
            $this->link_nodes($node, false);
            $this->char = $this->doc[--$this->pos];             return true;
        }
        ...
        $guard = 0;         $space = array($this->copy_skip($this->token_blank), '', '');
            ...
            if ($guard === $this->pos) {
                $this->char = (++$this->pos < $this->size) ? $this->doc[$this->pos] : null;                 continue;
            }
            $guard = $this->pos;
                ...
                $this->pos -= 2;
                $this->char = (++$this->pos < $this->size) ? $this->doc[$this->pos] : null;                 $this->link_nodes($node, false);
                return true;
            }
            ...
            if ($name !== '/' && $name !== '') {
                ...
                if ($this->char === '=') {
                    $this->char = (++$this->pos < $this->size) ? $this->doc[$this->pos] : null;                     $this->parse_attr($node, $name, $space);
                } else {
        ...
        protected function parse_attr($node, $name, &$space)
    {
        ...
        switch ($this->char) {
            case '"':
                ...
                $this->char = (++$this->pos < $this->size) ? $this->doc[$this->pos] : null;                 $node->attr[$name] = $this->restore_noise($this->copy_until_char_escape('"'));
                $this->char = (++$this->pos < $this->size) ? $this->doc[$this->pos] : null;                 break;
            case '\'':
    ...
    protected function copy_skip($chars)
    {
        ...
        $this->pos += $len;
        $this->char = ($this->pos < $this->size) ? $this->doc[$this->pos] : null;         if ($len === 0) return '';
    ...
    protected function copy_until($chars)
    {
        ...
        $this->pos += $len;
        $this->char = ($this->pos < $this->size) ? $this->doc[$this->pos] : null;         return substr($this->doc, $pos, $len);
    }
