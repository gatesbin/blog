...
namespace TechSoft\Laravel\MemberMoney;

use TechOnline\Laravel\Dao\ModelUtil;
use TechSoft\Laravel\MemberMoney\Types\MemberMoneyCashStatus;
use TechSoft\Laravel\MemberMoney\Types\MemberMoneyChargeStatus;
use TechSoft\Laravel\Shop\Util\ShopUtil;
...
class MemberMoneyUtil
{
    ...
    public static function createChange($memberUserId, $fee)
    {
        return ModelUtil::insert('member_money_charge', [
            'sn' => ShopUtil::generateSN(),
