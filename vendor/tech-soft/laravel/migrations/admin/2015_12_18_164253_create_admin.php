...
class CreateAdmin extends Migration
{
    ...
    public function up()
    {
        ...
        \TechOnline\Laravel\Dao\ModelUtil::insert('admin_user', [
            'username' => env('ADMIN_INIT_USERNAME', 'admin'),
            'passwordSalt' => $passwordSalt,
            'password' => \TechSoft\Laravel\Admin\Util\AdminUtil::passwordEncrypt(env('ADMIN_INIT_USERNAME', '123456'), $passwordSalt),
